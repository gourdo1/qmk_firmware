...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        KC_ESC,  KC_F1, KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_HOME,          ENCFUNC,
    ...
    [_FN1] = LAYOUT(
        ...
        _______, TG_CAPS, TG_PAD,  TG_TDCAP,TG_DEL,  TG_ENC,  TG_ESC,  _______, _______, _______, _______, RGB_TOD, RGB_TOI, _______,           RGB_TOG,
    ...
    [_FN1] = LAYOUT(
        EE_CLR,  KC_MYCM, KC_WHOM, KC_CALC, KC_MSEL, KC_MPRV, KC_MNXT, KC_MPLY, KC_MSTP, KC_VOLD, KC_VOLU, KC_PSCR, KC_SLCK, KC_PAUS,           KC_SLEP,
        _______, TG_CAPS, TG_PAD,  TG_TDCAP,TG_DEL,  TG_ENC,  _______, _______, _______, _______, _______, RGB_TOD, RGB_TOI, _______,           RGB_TOG,
