...
// Note: Many advanced functions referenced in this file are defined in /users/unpassive/unpassive.c
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	 ...
	 *
	 * ,--------------------------------------------------------------------------------------------------------------.
	 * | Esc  ||  F1  |  F2  |  F3  |  F4  ||  F5  |  F6  |  F7  |  F8  ||MdPrv |MdNxt | PtSc | Ins  || Del  || MdPly |
	 * |==============================================================================================================|
...
//LEFTOFENC, BELOWENC removed
	[_BASE] = LAYOUT(
		KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_MPRV, KC_MNXT, KC_PSCR, KC_INS,  KC_DEL,           ENCFUNC,
		KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,          KC_HOME,
		KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,          KC_END,
		CAPSNUM, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,           KC_PGUP,
	 ...
	 *
	 * ,-------------------------------------------------------------------------------------------------------------.
	 * | Esc  ||MyCmp |WbHom | Calc |MdSel ||MdPrv |MdNxt |MdPly |MdStp ||VolDn |  F9  | F10  | F11  || F12  || Mute |
	 * |=============================================================================================================|
	...
	#ifdef GAME_ENABLE
	[_FN1] = LAYOUT(
		EE_CLR,  KC_MYCM, KC_WHOM, KC_CALC, KC_MSEL, KC_MPRV, KC_MNXT, KC_MPLY, KC_MSTP, KC_F9, KC_F10, KC_F11, KC_F12, KC_DEL,                 KC_MUTE,
	 ...
	 * |------+------+------+------+------+------+------+------+------+------+------+------+------+----------++------|
	 * |  ______ | HOME |  Up  | END  | PGUP | None | None |  P4  |  P5  |  P6  |  P+  | ____ | ____ | _____ || WhUp |
	 * |---------+------+------+------+------+------+------+------+------+------+------+------+------+-------++------|
	 * |  ________  | Left | Down | Rght | PGDN| None | None |  P1  |  P2  |  P3  |  P*  | ____ |  P-Enter   || WhDn |
	 * |------------+------+------+------+-----+------+------+------+------+------+------+------|----+========+------|
	 * |  __________  | None | ____ | ____ | ____ | None | None |   0  |  00  |  P.  |  P/  |  MBt3  ||MS_UP || MBt2 |
	 * |--------------+------+------+------+------+------+------+------+------+------+------+--+=====++------++======|
	 * |  ____  |  ____  |  ____  |               _____                  | ____ | ____ | MBt1 || MS_LT |MS_DN |MS_RT |
	 * `-------------------------------------------------------------------------------------------------------------'
	 */
	...
	[_NUMPADMOUSE] = LAYOUT(
		...
		_______, KC_HOME, KC_UP,   KC_END, KC_PGUP,   KC_NO,   KC_NO,   KC_P4,   KC_P5,   KC_P6,   KC_PPLS, _______, _______, _______,          KC_WH_U,
		_______, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,   KC_NO,   KC_NO,   KC_P1,   KC_P2,   KC_P3,   KC_PAST, _______,          KC_PENT,          KC_WH_D,
		_______,          KC_NO,   _______, _______, _______, _______, _______, KC_P0,   KC_00,   KC_PDOT, KC_PSLS,          KC_BTN3, KC_MS_U, KC_BTN2,
		_______, _______, _______,                            KC_PENT,                            _______, _______, KC_BTN1, KC_MS_L, KC_MS_D, KC_MS_R
	),
	...
	[_MOUSEKEY] = LAYOUT(
		...
		_______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_BTN3, KC_MS_U, KC_BTN2,
